...
class Trainer:
    ...
    def fit(self, input_matrix, d_matrix, vl_input = None, vl_output = None):
        """
        ...
        for epoch in range (1, self.epochs + 1):
            ...
            if self.validation:
                epoch_vl_results = self._run_epoch_validation(vl_input, vl_output)
    ...
    def _run_epoch_validation(self, vl_input, vl_target):
        ...
        for idx in range(n_patterns):
            ...
            if accuracy(vl_final_output, d): correct_predictions += 1
