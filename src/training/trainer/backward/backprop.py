...
def delta_k(d: Array1D, x_k: Array1D, x_prev: Array1D, w_prev: Array2D, f_act: Callable ) -> Array1D:
    """
    ...
    if f_act == None:
        ...
        return (x_k - d) * f_act(net_k, True) #output function sigmoide con loss=MSE
