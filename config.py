...
LEARNING_RATE =  1e-3   #<- Funziona in batch ma da applicare il criterio di stop sennò scavalca il minimo
...
# ======== N EPOCHS ==========
EPOCHS = 500 #usato anche per determinare il numero di epoche per ogni run di grid search, 3% epochs ogni run
